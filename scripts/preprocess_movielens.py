...
# opt: normalize each movie's tag vector
...
# Movie–movie semantic similarity graph (cosine sim of genome tag vectors) 
...
# Final table for downstream experiments (ratings + movie text features) 
...
print("MovieLens preprocessing is done.")
